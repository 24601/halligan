...
| Event durability | Multi-worker capability negotiation | Implemented | runtime startup rejects stores without a conformance marker; the SQLite effect-ledger store advertises `axevent-store-v2` |
